...
const createTask = async (req, res) => {
  try {
    const { title, description, currentDate, deadline, priority, team, user, progress } = req.body;

    // Validate input data
    if (!title || !description || !currentDate || !deadline || !priority || !team || !user || progress === undefined) {
